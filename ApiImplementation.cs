...
namespace NukeDragon.TeamSnakemouth
{
  public sealed class ApiImplementation : ISnakemouthApi
  {
    ...
    public Dictionary<Deck, IStatusEntry> Inspired_Status_Dictionary => ModEntry.Instance.Inspired_Status_Dictionary;
    public Dictionary<Deck, IStatusEntry> Charged_Status_Dictionary => ModEntry.Instance.Charged_Status_Dictionary;
