using HarmonyLib;
using NukeDragon.TeamSnakemouth;
using System;
...
internal sealed class CustomTTGlossary : TTGlossary
{
  ...
  {
    harmony.Patch(AccessTools.DeclaredMethod(typeof(TTGlossary), nameof(BuildIconAndText)), prefix: new HarmonyMethod(typeof(CustomTTGlossary), nameof(TTGlossary_BuildIconAndText_Prefix)), finalizer: new HarmonyMethod(typeof(CustomTTGlossary), nameof(TTGlossary_BuildIconAndText_Finalizer)));
    harmony.Patch(AccessTools.DeclaredMethod(typeof(TTGlossary), "TryGetIcon"), prefix: new HarmonyMethod(typeof(CustomTTGlossary), nameof(TTGlossary_TryGetIcon_Prefix)));
    harmony.Patch(AccessTools.DeclaredMethod(typeof(TTGlossary), nameof(MakeNameDescPair)), prefix: new HarmonyMethod(typeof(CustomTTGlossary), nameof(TTGlossary_MakeNameDescPair_Prefix)));
    harmony.Patch(AccessTools.DeclaredMethod(typeof(TTGlossary), nameof(BuildString)), prefix: new HarmonyMethod(typeof(CustomTTGlossary), nameof(TTGlossary_BuildString_Prefix)));
  }
